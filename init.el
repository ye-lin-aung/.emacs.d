...
(custom-set-variables
 ...
 '(package-selected-packages
   '(ripgrep helm rg ag focus which-key company-web company auto-complete counsel-projectile undo-tree centaur-tabs org-bullets typo typo-mode olivetti poet-theme emojify use-package quelpa projectile dashboard all-the-icons)))
(custom-set-faces
